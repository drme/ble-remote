...
static const uint8 devInfoSerialNumber[] = "ble-x360 ("__DATE__")("__TIME__")";
...
static const uint8 devInfoFirmwareRev[] = "1.4 ("__DATE__")("__TIME__")";
...
static uint8 devInfo_ReadAttrCB( uint16 connHandle, gattAttribute_t *pAttr, uint8 *pValue, uint8 *pLen, uint16 offset, uint8 maxLen );
