...
static uint8 advertisementData[] =
{
	...
	LO_UINT16(BLE_X360_SERVICE_UUID),
	HI_UINT16(BLE_X360_SERVICE_UUID),
};

// GAP GATT Attributes
static uint8 attDeviceName[GAP_DEVICE_NAME_LEN] = "BLE-X360X";
...
{
 NULL, NULL // PasscodeCB,                     // Passcode callback (not used by application)
...
//	rcProfile_AddService(GATT_ALL_SERVICES);
	
	
	X360AddService(GATT_ALL_SERVICES);
	Batt_AddService();
